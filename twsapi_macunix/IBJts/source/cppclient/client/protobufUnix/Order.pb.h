...
class Order PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 hedgemaxsize() const;
  void set_hedgemaxsize(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_hedgemaxsize() const;
  void _internal_set_hedgemaxsize(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 hedgemaxsize_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::_internal_hedgemaxsize() const {
  return hedgemaxsize_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::hedgemaxsize() const {
  // @@protoc_insertion_point(field_get:protobuf.Order.hedgeMaxSize)
  return _internal_hedgemaxsize();
}
inline void Order::_internal_set_hedgemaxsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[4] |= 0x00000800u;
  hedgemaxsize_ = value;
}
inline void Order::set_hedgemaxsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
