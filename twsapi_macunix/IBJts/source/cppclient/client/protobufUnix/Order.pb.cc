...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::protobuf::Order, hedgemaxsize_),
  48,
  49,
  50,
  51,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Order_2eproto = {
  false, false, descriptor_table_protodef_Order_2eproto, "Order.proto", 7440,
...
Order::Order(const Order& from)
  ...
  ::memcpy(&clientid_, &from.clientid_,
    static_cast<size_t>(reinterpret_cast<char*>(&hedgemaxsize_) -
    reinterpret_cast<char*>(&clientid_)) + sizeof(hedgemaxsize_));
...
void Order::SharedCtor() {
  ...
  ::memset(&softdollartier_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&hedgemaxsize_) -
      reinterpret_cast<char*>(&softdollartier_)) + sizeof(hedgemaxsize_));
}
...
// @@protoc_insertion_point(message_clear_start:protobuf.Order)
  ...
  if (cached_has_bits & 0x00000f00u) {
    ::memset(&ignoreopenauction_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&hedgemaxsize_) -
        reinterpret_cast<char*>(&ignoreopenauction_)) + sizeof(hedgemaxsize_));
  }
  _has_bits_.Clear();
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 143:
        ...
        continue;
      // int32 hedgeMaxSize = 144;
      case 144:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 128)) {
          _Internal::set_has_hedgemaxsize(&_has_bits_);
          hedgemaxsize_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Order::_InternalSerialize(
  ...
  if (_internal_has_hedgemaxsize()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(144, this->_internal_hedgemaxsize(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf.Order)
  ...
  if (cached_has_bits & 0x00000f00u) {
    ...
    if (cached_has_bits & 0x00000800u) {
      hedgemaxsize_ = from.hedgemaxsize_;
    }
    _has_bits_[4] |= cached_has_bits;
  }
}
...
void Order::InternalSwap(Order* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Order, hedgemaxsize_)
      + sizeof(Order::hedgemaxsize_)
